...
def calculate_blue_from_evaluator(human_translation, translated_text):
    ...
    bleu_score = bleu_evaluator.evaluate(
        human_translation_sentences=human_translation,
...
if __name__ == "__main__":
    ...
    translated_text7 = "TO store the medication"
    ...
    human_translation, translated_text = (human_translate9,
                                          translated_text9
                                          )
    ...
    calculate_bleu_tokenized(human_translation, translated_text)
